...
Revision ID: ce3bb570cc65
Revises: d198c035956e
Create Date: 2020-06-15 11:23:28.082858
...
revision = 'ce3bb570cc65'
down_revision = 'd198c035956e'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('user_email', sa.String(length=255, collation='NOCASE'), nullable=False),
    sa.PrimaryKeyConstraint('id'),
